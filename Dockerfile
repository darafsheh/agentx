...
#Always run:
    ...
    # docker build -t agentx-server .
    # docker run -d --name agentx-server   -p 3000:3000   --env-file .env   agentx-server   pnpm start --characters="agentx.character.json" //Start server
